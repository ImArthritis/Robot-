...
void processKeyDown(int keyCode)
{
  if (!curKeys[keyCode])
  {
    ...
    {
      Serial.println("Left Servo DOWN"); //Move left servo down
      servoLeft.write(90);
      delay(10);
    }
    else if(keyCode == K_x)//120
    {
      Serial.println("Right Servo DOWN"); //Move right servo down
      servoRight.write(90);
      delay(15);
    }
...
void processKeyUp(int keyCode)
{
  if (curKeys[keyCode])
  {
    ...
    {
      Serial.println("Left Servo UP"); //Move left servo up
      servoLeft.write(45);
      delay(10);
    }
    else if(keyCode == K_x) //120
    {
      Serial.println("Right Servo UP"); //Move right servo up
      servoRight.write(125);
      delay(15);
    }
    else if(keyCode == K_LEFT) //276
